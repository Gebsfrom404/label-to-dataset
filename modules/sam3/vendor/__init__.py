...
# Video/tracking model + predictor builders (_build_sam3_video_model_unused,
# build_sam3_video_predictor) are dropped — this app only uses SAM3 for single
# images (point-click Magic Wand + text-prompt detection), and dropping them
# avoids a psutil dependency (Sam3VideoPredictor lives in predictor.py, which
# isn't vendored).
